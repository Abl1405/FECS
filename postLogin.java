...
public class postLogin extends javax.swing.JFrame {
     ...
     */
    public postLogin(String user, String name) {
        initComponents();
        currentUser=user;
        nameUser = name;
    ...
    private void initComponents() {
        ...
        jButton1.setText("Your Carbon Footprint");
        ...
        jButton2.setText("Carpool with Other Users");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(loginStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 237, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        footprintCalculator d = new footprintCalculator(currentUser, nameUser);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        carpool u = new carpool(currentUser, nameUser);
        this.setVisible(false);
        u.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new postLogin(currentUser, nameUser).setVisible(true);
            }
        });
    }
